...
metadata {
	definition (name: "NYCE Ceiling Motion Sensor", namespace: "NYCE", author: "NYCE", mnmn: "SmartThings", vid: "generic-motion-6") {
		capability "Battery"
	...
	tiles(scale: 2) {
        ...
        valueTile("humidity", "device.humidity", width: 2, height: 2) {
			state("humidity", label:'${currentValue}${unit}', unit:'%', icon:"st.Weather.weather12", 
            backgroundColors:[
					[value: 16, color: "#153591"],
					[value: 31, color: "#90d2a7"],
					[value: 51, color: "#44b621"],
					[value: 64, color: "#f1d801"],
					[value: 81, color: "#d04e00"],
					[value: 96, color: "#bc2323"]
				]
		...
		main (["motion"])
		details(["motion","temperature","battery","humidity","refresh"])
 	}
}
