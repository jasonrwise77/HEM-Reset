...
page name: "main"
            def main() {
               ...
               app(name: "profiles daily", appName: "HEM Daily Reset Manager", namespace: "jasonrwise77", title: "Create a new HEM Profile", multiple: true,  uninstall: false)
	app(name: "profiles monthly", appName: "HEM Monthly Reset Manager", namespace: "jasonrwise77", title: "Create a new HEM Profile", multiple: true,  uninstall: false)
                        }
                    }
}
